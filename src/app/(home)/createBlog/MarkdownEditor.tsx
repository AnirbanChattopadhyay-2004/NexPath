...
const MarkdownEditor = () => {
    ...
    return (
        <>
        <form action={async() => await addBlog(markdown , user?.primaryEmailAddress?.emailAddress as string , title)}>
        ...
        <div className="flex flex-col items-center space-y-2">
            ...
            <div>
                <input className='p-2' placeholder='Enter Title' onChange={(e)=>{setTitle(e.target.value)}}></input>
            </div>
        </div>
