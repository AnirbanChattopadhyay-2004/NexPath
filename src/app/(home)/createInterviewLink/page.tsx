  ...
  if (roomid.length >= 1) {
    ...
    return (
      <div className="flex items-center gap-2 bg-gray-800 p-2 rounded-md">
        <p>{link}</p>
        <button onClick={copyToClipboard} className="p-1 bg-gray-800 rounded-md">
...
function ButtonForm(){
    ...
    return(
        <Button type="submit" className="p-3 bg-black hover:bg-gray-800">{pending ? "Creating..." : "Create Link"}</Button>
    )
}
