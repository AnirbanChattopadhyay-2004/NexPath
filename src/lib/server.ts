...
export async function addBlog(markdown : string , authorEmail :string , title : string){
    try{
...
export async function createDiscussion(title : string , img : string , description : string , AuthorEmail : string){
    try{    
        const id = await getAuthorByMail(AuthorEmail);
...
export async function addWebinar(date : Date , title: string , description : string , mail : string){
    try{    
...
export async function getReccomendation(userEmail : string , text : string , same : boolean){
    try{
        if(same){
